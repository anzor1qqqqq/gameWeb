    ...
    return (  
            <div className='block_card' key={id}>
                <div className='contant_card'>
                    ...
                    <span className='contant_card_image_btn top'>Топ 4</span>
                </div>
                
                <div className='block_info'>
                    <div className='block_info_value'>
                        <span className='block_info_value_product'>{data.price} ₽</span>
                        {data.sale 
                        ? <> <span className='block_info_value_procent_sale'>{data.sale}%</span> <span className='block_info_value_for_sale'>{parseInt((data.price - (data.price * (data.sale / 100))))} ₽</span> </>
                        : ''}
                    </div>
