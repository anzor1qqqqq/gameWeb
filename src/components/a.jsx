...
const A = memo(({addBusketProduct, addFavorProduct, data, stateValue, index, spanText}) => {
    return (
        <div className='contant_card'>
                <img className='contant_card_image' src={data.img} alt="" />
                {stateValue.basket.find(item => item.id === index) 
                ...
                {stateValue.favority.includes(index)
