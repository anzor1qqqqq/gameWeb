...
import { IPropsHeaderSearch, IStateStore, ILoaderData } from '../../types/types';
    ...
    return (  
        <div className='header_search'>
                    ...
                    <div className='header_search_contant_input'>
                        <input className='header_search_contant_input-input' type="text" placeholder='Поиск' onChange={searchProduct}/>
