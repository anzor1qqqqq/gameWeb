        ...
        <div className='header_search'>
                    ...
                    <div className='header_search_contant_like_busket'>
                        <div className='header_search_contant_like_busket-like'>
                            ...
                            {stateValueFavor.length ? <span className='header_search_contant_like_busket-count'>{stateValueFavor.length}</span> : ''}
                        </div>
                        ...
                        <div className='header_search_contant_like_busket-busket'>
                            ...
                            {stateValueBusket.length ? <span className='header_search_contant_like_busket-count'>{stateValueBusket.length}</span> : ''}
                        </div>
                    </div>
                </div>
    );
