    ...
    return (
        <div className='containerSVG'>
            <div className='contantBasket'>
                <svg className={aboutBasket ? 'iconSvgBasketLike add' : 'iconSvgBasketLike'} viewBox="0 0 24 25" xmlns="http://www.w3.org/2000/svg"  onClick={event => callbackBasket(index, event.target as HTMLElement)}>
            ...
            <div>
                <svg className={aboutFavority ? 'iconSvgBasketLike add' : 'iconSvgBasketLike'} viewBox="0 0 26 21" xmlns="http://www.w3.org/2000/svg" onClick={event => callbackFavor(index, event.target as HTMLElement)}>
